...
variable "node_min_size_cpu" {
  description = "Minimum size of a cpu node."
  type        = string
  default     = 0
}

variable "node_desired_size_cpu" {
  description = "Desired size of a cpu node."
  type        = string
  default     = 2
}

variable "node_max_size_cpu" {
  description = "Maximum size of a cpu node."
  type        = string
  default     = 5
}
...
variable "node_min_size_gpu" {
  description = "Minimum size of a gpu node."
  type        = string
  default     = 0
}

variable "node_desired_size_gpu" {
  description = "Desired size of a gpu node."
  type        = string
  default     = 2
}

variable "node_max_size_gpu" {
  description = "Maximum size of a gpu node."
  type        = string
  default     = 5
}
