locals {
  ...
  managed_node_group_cpu = {
    ...
    min_size        = var.node_min_size_cpu
    desired_size    = var.node_desired_size_cpu
    max_size        = var.node_max_size_cpu
  ...
  managed_node_group_gpu = local.using_gpu ? {
    ...
    min_size        = var.node_min_size_gpu
    desired_size    = var.node_desired_size_gpu
    max_size        = var.node_max_size_gpu
